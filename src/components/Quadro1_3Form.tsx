...
export default function Quadro1_3Form() {
  ...
  return (
    <FormContainer 
      title="QUADRO 1.3 NÚMERO DE ESTUDANTES NOVOS INGRESSO, MATRICULADOS, GRADUADOS POR GRAU, SEXO E CURSOS EM FUNCIONAMENTO NO ANO ACADÉMICO - (ANO N-1)" 
      description="Preenchimento de dados estatísticos"
      onEnviar={() => alert('Quadro 1.3 enviado para a Repartição de Estatística!')}
    >
